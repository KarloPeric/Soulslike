    ...
    ""maps"": [
        {
            ...
            ""id"": ""6308e1a2-ad1c-4403-acf9-b499983f18a0"",
            ""actions"": [
                {
                    ""name"": ""Movement"",
                    ""type"": ""PassThrough"",
                    ""id"": ""eeb911c0-c786-479d-876f-41c77e2b677b"",
                ...
                },
                {
                    ""name"": ""Camera"",
                    ""type"": ""PassThrough"",
                    ""id"": ""0ced1c6d-fae1-4423-9f01-2855727d1f58"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": ""WASD"",
                    ""id"": ""798534cd-5a41-4975-b5b8-b581ab48052d"",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""4a5c84e1-ea8a-4936-a661-461c6219b1a8"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""d6c9895c-47b0-4e7c-815b-773ada626086"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Mouse and Keyboard"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""f60daa83-96b7-4886-b5e8-02663b9068f5"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Mouse and Keyboard"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""a9edd363-a593-4f54-9bbc-d01b2793d661"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Mouse and Keyboard"",
                ...
                {
                    ""name"": """",
                    ""id"": ""89afb195-cff2-4395-8cfa-eabc323f2f52"",
                ...
                {
                    ""name"": """",
                    ""id"": ""5ee67f94-c12f-4a7a-80ca-512b0007c2ac"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
        ...
        {
            ""name"": ""Player Actions"",
            ""id"": ""853d5b3c-cd60-4e94-b6af-bb3ab59bb771"",
            ""actions"": [
                {
                    ""name"": ""Roll"",
                    ""type"": ""Button"",
                    ""id"": ""bfe7182c-5f19-4339-8815-e43c035735e6"",
                ...
                },
                {
                    ""name"": ""Walk"",
                    ""type"": ""Button"",
                    ""id"": ""8db3edeb-e216-4128-b530-e4dceeae4346"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""RB"",
                    ""type"": ""Button"",
                    ""id"": ""14c35498-06f6-47d1-856d-1b8e5e272a32"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""RT"",
                    ""type"": ""Button"",
                    ""id"": ""861a3944-8267-4e73-a362-6b8e448240db"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""7546c2a8-4288-432a-89a2-64d7b3827099"",
                ...
                {
                    ""name"": """",
                    ""id"": ""fd5b3dec-52a8-4cf1-9c21-1c7ac9b3029c"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Mouse and Keyboard"",
                ...
                {
                    ""name"": """",
                    ""id"": ""cff1de7b-4c37-415f-a246-8f29aabb61bc"",
                    ""path"": ""<Keyboard>/shift"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Mouse and Keyboard"",
                ...
                {
                    ""name"": """",
                    ""id"": ""3d1b89c0-c182-4635-b69a-cb4ded65c245"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Mouse and Keyboard"",
                ...
                {
                    ""name"": """",
                    ""id"": ""0e332663-aab5-425c-a4c5-fa7a0afb2162"",
                ...
                {
                    ""name"": """",
                    ""id"": ""f9c4213f-1617-4ede-990b-1567b55d3da9"",
                    ""path"": ""<Keyboard>/r"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Mouse and Keyboard"",
                ...
                {
                    ""name"": """",
                    ""id"": ""93f75ec0-4889-4b4d-b5b6-de5b37f31bc5"",
        ...
        },
        {
            ...
            ""id"": ""18838933-e777-4580-b122-c4513805dc98"",
            ""actions"": [
                {
                    ""name"": ""D-Pad Up"",
                    ""type"": ""Button"",
                    ""id"": ""388ba87c-85b7-40a5-8681-49d9203d317b"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""D-Pad Down"",
                    ""type"": ""Button"",
                    ""id"": ""b8c3ad6b-800b-47a3-8aa8-f17accbda8bf"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""D-Pad Left"",
                    ""type"": ""Button"",
                    ""id"": ""1b76e1c7-1948-463f-9bdd-64f90f037eb6"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""D-Pad Right"",
                    ""type"": ""Button"",
                    ""id"": ""1c8a4577-ade9-4d94-a3bf-53c6ce63ab01"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""385fd3f1-f50d-4fc2-82ca-2cb1f6567df7"",
                ...
                {
                    ""name"": """",
                    ""id"": ""0cce6a2d-550a-4a31-be54-89f39ccd1ed6"",
                ...
                {
                    ""name"": """",
                    ""id"": ""df23dc6f-78cc-48b8-a4a5-43752f5dbe83"",
                ...
                {
                    ""name"": """",
                    ""id"": ""3befaba0-0ea5-4de9-b349-d45c005812d2"",
                ...
                {
                    ""name"": """",
                    ""id"": ""de2d0d16-40da-43ac-9f04-e30e6de200ca"",
                ...
                {
                    ""name"": """",
                    ""id"": ""8eee7d16-b4e6-470b-8d82-2ab89748cbe4"",
                ...
                {
                    ""name"": """",
                    ""id"": ""27e0d7c2-424e-4ddb-878b-a2b6728ebf11"",
                ...
                {
                    ""name"": """",
                    ""id"": ""e3f04680-be0e-4963-92e7-ca92805fab88"",
